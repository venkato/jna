...
public class Function extends Pointer {
   ...
   public Function(Pointer functionAddress, int callFlags, String encoding) {
    ...
    public Object invoke(Object[] args, Class returnType, boolean allowObjects) {
        ...
        if (returnType == null || returnType==void.class || returnType==Void.class) {
            Native.invokeVoid(peer, callFlags, args,this);
            result = null;
        }
        else if (returnType==boolean.class || returnType==Boolean.class) {
            result = valueOf(Native.invokeInt(peer, callFlags, args,this) != 0);
        }
        else if (returnType==byte.class || returnType==Byte.class) {
            result = new Byte((byte)Native.invokeInt(peer, callFlags, args,this));
        }
        else if (returnType==short.class || returnType==Short.class) {
            result = new Short((short)Native.invokeInt(peer, callFlags, args,this));
        }
        else if (returnType==char.class || returnType==Character.class) {
            result = new Character((char)Native.invokeInt(peer, callFlags, args,this));
        }
        else if (returnType==int.class || returnType==Integer.class) {
            result = new Integer(Native.invokeInt(peer, callFlags, args,this));
        }
        else if (returnType==long.class || returnType==Long.class) {
            result = new Long(Native.invokeLong(peer, callFlags, args,this));
        }
        else if (returnType==float.class || returnType==Float.class) {
            result = new Float(Native.invokeFloat(peer, callFlags, args,this));
        }
        else if (returnType==double.class || returnType==Double.class) {
            result = new Double(Native.invokeDouble(peer, callFlags, args,this));
        }
        else if (returnType==String.class) {
            result = invokeString(callFlags, args, false,this);
        }
        else if (returnType==WString.class) {
            String s = invokeString(callFlags, args, true,this);
            if (s != null) {
            ...
            if (Structure.ByValue.class.isAssignableFrom(returnType)) {
                Structure s = 
                    Native.invokeStructure(peer, callFlags, args,
                                           Structure.newInstance(returnType),this);
                s.autoRead();
                result = s;
            }
            else {
            ...
            result = Native.invokeObject(peer, callFlags, args,this);
            if (result != null
    ...
    private Pointer invokePointer(int callFlags, Object[] args) {
        long ptr = Native.invokePointer(peer, callFlags, args,this);
        return ptr == 0 ? null : new Pointer(ptr);
    }

    protected Object convertArgument(Object[] args, int index,
     ...
     */
    private String invokeString(int callFlags, Object[] args, boolean wide,Function function) {
 ...
 // user version with long parameters
 	@Deprecated
 	public void processParams(int flags, Object[] params, int resultPointer,
 			int jniEnvPointer) {
 		processParams(flags, params, (long) resultPointer, (long) jniEnvPointer);
 	}

 	public void processParams(int flags, Object[] params, long resultPointer,
 			long jniEnvPointer) {
 		// log.info(Arrays.asList(params));
 		// jobject self, jint flags, jobjectArray arr,
	...
	public void processResult(int flags, Object[] params,
			int resultPointer) {
		processResult(flags, params, (long) resultPointer);
	}
