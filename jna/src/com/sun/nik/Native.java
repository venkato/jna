...
import static com.sun.nik.JnaNativeParams.*;

import com.sun.nik.Callback.UncaughtExceptionHandler;
import com.sun.nik.Structure.FFIType;
...
public final class Native implements Version {
    ...
    public static Map options = new WeakHashMap();
    public static Map libraries = new WeakHashMap();
    public static UncaughtExceptionHandler DEFAULT_HANDLER =
    ...
    public static UncaughtExceptionHandler callbackExceptionHandler = DEFAULT_HANDLER;
    ...
    public static final int TYPE_VOIDP = 0;
    public static final int TYPE_LONG = 1;
    public static final int TYPE_WCHAR_T = 2;
    public static final int TYPE_SIZE_T = 3;
...
//        loadNativeDispatchLibrary();
        ...
        initIDs();
        if (JnaNativeParams.protectedSome) {
            setProtected(true);
        }
        ...
        if (version != parseVersion(VERSION_NATIVE)) {
            ...
            throw new Error(LS + LS
                            ...
                            + " - set the system property nik.nosys=true" + LS
                            + " - set nik.boot.library.path to include the path to the version of the " + LS
    ...
    public  static native long getWindowHandle0(Component c);
     ...
     * See {@link com.sun.nik.Library#OPTION_TYPE_MAPPER}.
     */
     ...
     * See {@link com.sun.nik.Library#OPTION_STRING_ENCODING}.
     */
     ...
     * property <code>jna.encoding</code> or {@link JnaNativeParams#DEFAULT_ENCODING}.
     */
    public static String getDefaultStringEncoding() {
        return System.getProperty("nik.encoding", JnaNativeParams.DEFAULT_ENCODING);
    }

    /** Return the preferred structure alignment for the given native interface.
     * See {@link com.sun.nik.Library#OPTION_STRUCTURE_ALIGNMENT}.
     */
    ...
    */
    ...
    static final String JNA_TMPLIB_PREFIX = "nik";
    /**
    ...
    public static File extractFromResourcePath(String name, ClassLoader loader) throws IOException {
        ...
        if (DEBUG) {
            log.info("Looking in classpath from " + loader + " for " + name);
        }
        ...
        if (DEBUG) {
            log.info("Found library resource at " + url);
        }
        ...
        if (url.getProtocol().toLowerCase().equals("file")) {
            ...
            if (DEBUG) {
                log.info("Looking in " + lib.getAbsolutePath());
            }
            if (!lib.exists()) {
                throw new IOException("File URL " + url + " could not be properly decoded");
            }
        }
        else if (!Boolean.getBoolean("nik.nounpack")) {
    ...
    */
    public static File getTempDir() throws IOException {
        File jnatmp;
        String prop = System.getProperty("nik.tmpdir");
        if (prop != null) {
            ...
            jnatmp = new File(tmp, "nik-" + System.getProperty("user.name").hashCode());
            jnatmp.mkdirs();
    ...
    */
    ...
    public  static int getConversion(Class type, TypeMapper mapper) {
    ...
    */
    ...
    public  static synchronized native void freeNativeCallback(long ptr);
     ...
     */
    public static synchronized native long createNativeCallback(Callback callback,
                                                         Method method,
     ...
     */
    public  static  native int invokeInt(long fp, int callFlags, Object[] args,Function functionExt);

    public static  native int invokeWithJniEnv(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     * @return  The value returned by the target native function
     */
    public    static native long invokeLong(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     *                  Arguments to pass to the native function
     */
    public static native void invokeVoid(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     * @return  The value returned by the target native function
     */
    public static native float invokeFloat(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     * @return  The value returned by the target native function
     */
    public static native double invokeDouble(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     */
    public  static native long invokePointer(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     */
    public  static native void invokeStructure(long fp, int callFlags,
                                               Object[] args, long memory,
                                               long type_info,Function functionExt);
     ...
     */
    public static Structure invokeStructure(long fp, int callFlags, Object[] args,
                                     Structure s,Function functionExt) {
        invokeStructure(fp, callFlags, args, s.getPointer().peer,
                        s.getTypeInfo().peer,functionExt);
        return s;
    }
     ...
     */
    public  static native Object invokeObject(long fp, int callFlags, Object[] args,Function functionExt);
     ...
     * otions.
     */
    public static native long open(String name, int flags);

    /** Close the given native library. */
    public static native void close(long handle);

    public static native long findSymbol(long handle, String name);

    public static native long indexOf(long addr, byte value);

    public  static native void read(long addr, byte[] buf, int index, int length);

    public  static native void read(long addr, short[] buf, int index, int length);

    public  static native void read(long addr, char[] buf, int index, int length);

    public   static native void read(long addr, int[] buf, int index, int length);

    public  static native void read(long addr, long[] buf, int index, int length);

    public  static native void read(long addr, float[] buf, int index, int length);

    public   static native void read(long addr, double[] buf, int index, int length);

    public   static native void write(long addr, byte[] buf, int index, int length);

    public   static native void write(long addr, short[] buf, int index, int length);

    public    static native void write(long addr, char[] buf, int index, int length);

    public    static native void write(long addr, int[] buf, int index, int length);

    public  static native void write(long addr, long[] buf, int index, int length);

    public   static native void write(long addr, float[] buf, int index, int length);

    public   static native void write(long addr, double[] buf, int index, int length);

    public static native byte getByte(long addr);

    public    static native char getChar(long addr);

    public   static native short getShort(long addr);

    public  static native int getInt(long addr);

    public  static native long getLong(long addr);
    ...
    public  static native long _getPointer(long addr);

    public static native String getWideString(long addr);

    public  static String getString(long addr) {
        return getString(addr, getDefaultStringEncoding());
    }

    public static String getString(long addr, String encoding) {
    ...
    public  static native byte[] getStringBytes(long addr);

    public static native void setMemory(long addr, long length, byte value);

    public static native void setByte(long addr, byte value);

    public static native void setShort(long addr, short value);

    public static native void setChar(long addr, char value);

    public static native void setInt(long addr, int value);

    public static native void setLong(long addr, long value);

    public  static native void setFloat(long addr, float value);

    public static native void setDouble(long addr, double value);

    public static native void setPointer(long addr, long value);

    public static native void setWideString(long addr, String value);
    ...
    public static native void setNikDebugMode(int debug);

    public static native int getNikDebugMode();
