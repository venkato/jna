...
public class NativeLibrary {
        ...
        if (Platform.isWindows() && "kernel32".equals(this.libraryName.toLowerCase())) {
            synchronized(functions) {
                Function f = new Function(this, "GetLastError", Function.ALT_CONVENTION, encoding) {
                        public Object invoke(Object[] args, Class returnType, boolean b) {
	...
	if (JnaNativeParams.DEBUG_LOAD ) {
	    System.out.println("Adding paths from jna.library.path: " + System.getProperty("nik.library.path"));
	}
        searchPath.addAll(initPaths("nik.library.path"));
    ...
    Function getFunction(String name, Method method) {
        ...
        String prefix = System.getProperty("nik.profiler.prefix", "$$YJP$$");
    ...
    */
    ...
    static {
        ...
        if (System.getProperty("nik.platform.library.path") == null
            && !Platform.isWindows()) {
            ...
            if (!"".equals(platformPath)) {
                System.setProperty("nik.platform.library.path", platformPath);
            }
        }
        librarySearchPath.addAll(initPaths("nik.platform.library.path"));
    }
