...
import com.sun.nik.CallbacksTest.TestLibrary.CbCallback;
import com.sun.nik.ptr.IntByReference;
import com.sun.nik.ptr.PointerByReference;
import com.sun.nik.win32.W32APIOptions;
...
public class CallbacksTest extends TestCase implements Paths {
    ...
    */
    ...
    public void testDLLCallback() throws Exception {
        ...
        final boolean[] called = { false };
        class TestCallback implements TestLibrary.VoidCallback, com.sun.nik.win32.DLLCallback {
            public void callback() {
                called[0] = true;
            }
        }
