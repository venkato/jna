...
public class JNALoadTest extends TestCase implements Paths {
    ...
    protected void assertLibraryExists() {
        ...
        File lib = new File(CLASSES + "/com/sun/nik/" + osPrefix + "/" + name);
        if (!lib.exists()) {
    ...
    public void testAvoidJarUnpacking() throws Exception {
        ...
        try {
            Class cls = Class.forName("com.sun.nik.Native", true, new TestLoader(true));

            fail("Class com.sun.nik.Native should not be loadable if jna.nounpack=true: "
                 + cls.getClassLoader());
        }
    ...
    public void testAvoidResourcePathLoading() throws Exception {
        ...
        try {
            Class cls = Class.forName("com.sun.nik.Native", true, new TestLoader(false));

            fail("Class com.sun.nik.Native should not be loadable if jna.noclasspath=true: "
                 + cls.getClassLoader());
        }
        catch(UnsatisfiedLinkError e) {
        }
    ...
    public void testLoadAndUnloadFromJar() throws Exception {
        ...
        Class cls = Class.forName("com.sun.nik.Native", true, loader);
        ...
        try {
            ...
            cls = Class.forName("com.sun.nik.Native", true, loader);
        }
        catch(Throwable t) {
