...
#include "ffi.h"
#include "com_sun_nik_Function.h"
#include "com_sun_nik_Native.h"
...
#define CB_OPTION_DIRECT com_sun_nik_Native_CB_OPTION_DIRECT
#define CB_OPTION_IN_DLL com_sun_nik_Native_CB_OPTION_IN_DLL

/* These are the calling conventions an invocation can handle. */
typedef enum _callconv {
    CALLCONV_C = com_sun_nik_Function_C_CONVENTION,
#ifdef _WIN32
    CALLCONV_STDCALL = com_sun_nik_Function_ALT_CONVENTION,
#endif
} callconv_t;

/* Maximum number of allowed arguments in libffi. */
#define MAX_NARGS com_sun_nik_Function_MAX_NARGS

enum {
  CVT_DEFAULT = com_sun_nik_Native_CVT_DEFAULT,
  CVT_POINTER = com_sun_nik_Native_CVT_POINTER,
  CVT_STRING = com_sun_nik_Native_CVT_STRING,
  CVT_STRUCTURE = com_sun_nik_Native_CVT_STRUCTURE,
  CVT_STRUCTURE_BYVAL = com_sun_nik_Native_CVT_STRUCTURE_BYVAL,
  CVT_BUFFER = com_sun_nik_Native_CVT_BUFFER,
  CVT_ARRAY_BYTE = com_sun_nik_Native_CVT_ARRAY_BYTE,
  CVT_ARRAY_SHORT = com_sun_nik_Native_CVT_ARRAY_SHORT,
  CVT_ARRAY_CHAR = com_sun_nik_Native_CVT_ARRAY_CHAR,
  CVT_ARRAY_INT = com_sun_nik_Native_CVT_ARRAY_INT,
  CVT_ARRAY_LONG = com_sun_nik_Native_CVT_ARRAY_LONG,
  CVT_ARRAY_FLOAT = com_sun_nik_Native_CVT_ARRAY_FLOAT,
  CVT_ARRAY_DOUBLE = com_sun_nik_Native_CVT_ARRAY_DOUBLE,
  CVT_ARRAY_BOOLEAN = com_sun_nik_Native_CVT_ARRAY_BOOLEAN,
  CVT_BOOLEAN = com_sun_nik_Native_CVT_BOOLEAN,
  CVT_CALLBACK = com_sun_nik_Native_CVT_CALLBACK,
  CVT_FLOAT = com_sun_nik_Native_CVT_FLOAT,
  CVT_NATIVE_MAPPED = com_sun_nik_Native_CVT_NATIVE_MAPPED,
  CVT_WSTRING = com_sun_nik_Native_CVT_WSTRING,
  CVT_INTEGER_TYPE = com_sun_nik_Native_CVT_INTEGER_TYPE,
  CVT_POINTER_TYPE = com_sun_nik_Native_CVT_POINTER_TYPE,
  CVT_TYPE_MAPPER = com_sun_nik_Native_CVT_TYPE_MAPPER,
};

/* callback behavior flags */
enum {
  CB_HAS_INITIALIZER = com_sun_nik_Native_CB_HAS_INITIALIZER,
};
...
#define ELastError "com/sun/nik/LastErrorException"
